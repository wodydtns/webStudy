...
//		){
//			oos.writeObject(vo1); // JVM이 읽을 수 있는 데이터(직렬화한 데이터)
//			
//		}catch(IOException e) {
//			e.printStackTrace();
//		}
		File readFile = new File("d:/test.dat");
		try(
				FileInputStream fis = new FileInputStream(readFile);
				ObjectInputStream ois = new ObjectInputStream(fis);
		){
			TestVO vo2 = (TestVO) ois.readObject(); // 역직렬화
			System.out.println(vo2.getNumber());
			System.out.println(vo2.getDblNumber());
			System.out.println(vo2.getTestArray());
